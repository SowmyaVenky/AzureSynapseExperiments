...
/**
 * This program will read from a kafka topic, reformat the payload to meet the
 * format of the base delta table, and then peform merges with it to update the
 * data. The offsets are adjusted as we go to pull new data that is available,
 * and merge. Once there is no data present in KAFKA, the program waits for 3
 * minutes and exists. This can be a base for more complicated event driven
 * integrations.
 */
