...
public class FakeUsersGenerator {
    ...
    public static void main(String[] args) {
        if (args == null || args.length != 2) {
            System.out.println("Need to pass 2 parameter - ratings.csv and output folder for this to work!");
            System.exit(-1);
        }
        ...
        if (WRITE_FILE_OUTPUTS) {
            ...
            fakeUsers.write().mode(SaveMode.Overwrite).parquet(outputFolder + "/users");
        }
